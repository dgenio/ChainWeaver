...
| `chainweaver-version` | `0.14.1` | Exact PyPI version to install. Pass `""` for the latest published release. |
...
Pin to a ChainWeaver release tag (`@v0.14.1`) rather than `@main` to avoid
